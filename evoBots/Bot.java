...
import evoBots.World.Optimisation;
...
public class Bot extends JPanel {
    ...
    private void makeChildren(int howmany) {
        for (int i = 0; i < howmany; i++) {
            Agent a = new Agent(new Network(agent.getNet().getDescriptor()));
    ...
    /**
     * is a method which resizeÂ´s the bot relative to the WorldÂ´s Chunk size
     */
